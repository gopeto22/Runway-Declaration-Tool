...
<<<<<<< HEAD
    ...
    private void takeOffAwayLandingOver() {
        ...
        toraCalc = originalTora.get() + "m - " + blastProtection + "m - " + obstacle.getDistanceFromThreshold() + "m - " + displacedThreshold + "m";
        ...
        todaCalc = redeclaredTora.get() + "m + " + clearway + "m";
        ...
        asdaCalc = redeclaredTora.get() + "m + " + stopway + "m";
        ...
        if (als + stripEnd < blastProtection) {
            ...
            ldaCalc = originalTora.get() + "m - " + displacedThreshold + "m - " + obstacle.getDistanceFromThreshold() + "m - " + blastProtection + "m";
            ...
            ldaCalc = originalTora.get() + "m - " + displacedThreshold + "m - " + obstacle.getDistanceFromThreshold() + "m - (50 * " + obstacle.getHeight() + "m) - " + stripEnd + "m";
            redeclaredLdaMap.put("Displaced Threshold", displacedThreshold);
            redeclaredLdaMap.put("Distance From Threshold", obstacle.getDistanceFromThreshold());
            ...
            ldaCalc = originalTora.get() + "m - " + displacedThreshold + "m - " + obstacle.getDistanceFromThreshold() + "m - " + resa + "m - " + stripEnd + "m";
            redeclaredLdaMap.put("Displaced Threshold", displacedThreshold);
            redeclaredLdaMap.put("Distance From Threshold", obstacle.getDistanceFromThreshold());
    ...
    private void takeOffTowardsLandingTowards() {
        ...
        if (50 * obstacle.getHeight() > resa) {
            ...
            toraCalc = obstacle.getDistanceFromThreshold() + "m + " + displacedThreshold + "m - (50 * " + obstacle.getHeight() + "m) - " + stripEnd + "m";
            redeclaredToraMap.put("Distance From Threshold", obstacle.getDistanceFromThreshold());
            redeclaredToraMap.put("Displaced Threshold", displacedThreshold);
            ...
            toraCalc = obstacle.getDistanceFromThreshold() + "m + " + displacedThreshold + "m - " + resa + "m - " + stripEnd + "m";
            redeclaredToraMap.put("Distance From Threshold", obstacle.getDistanceFromThreshold());
            redeclaredToraMap.put("Displaced Threshold", displacedThreshold);
        ...
        todaCalc = Integer.toString(redeclaredTora.get()) + "m";
        redeclaredTodaMap = redeclaredToraMap;

        asdaEq = "ASDA = Recalculated TORA";
        asdaCalc = Integer.toString(redeclaredTora.get()) + "m";
        ...
        ldaCalc = obstacle.getDistanceFromThreshold() + "m - " + resa + "m - " + stripEnd + "m";
        redeclaredLdaMap.put("Displaced Threshold", displacedThreshold);
        redeclaredLdaMap.put("Distance From Threshold", obstacle.getDistanceFromThreshold());
        redeclaredLdaMap.put("RESA", resa);
        redeclaredLdaMap.put("Strip End", stripEnd);
    ...
    private void noCalc() {
        ...
        toraCalc = Integer.toString(originalTora.get()) + "m";
        todaEq = "TODA = TORA + Clearway";
        todaCalc = originalTora.get() + "m + " + clearway + "m";
        asdaEq = "ASDA = TORA + Stopway";
        asdaCalc = originalTora.get() + "m + " + stopway + "m";
        ldaEq = "LDA = TORA - Displaced Threshold";
        ldaCalc = originalTora.get() + "m - " + displacedThreshold + "m";
    ...
    public void recalculate() {
        System.out.println("Trying to recalculate");
        ...
        else if ((displacedThreshold > 0) && (distanceFromCentreline > 75 || (displacedThreshold + obstacle.getDistanceFromThreshold() < (-stripEnd)) ||
                ((displacedThreshold + obstacle.getDistanceFromThreshold()) > (originalTora.get() + stripEnd)))) {
            System.out.println("Obstacle is not blocking the runway - no recalculations needed.");
            System.out.println("displacedThreshold + obstacleDistance = " + (displacedThreshold + obstacle.getDistanceFromThreshold()));
            System.out.println("originalToda + stripEnd = " + (originalTora.get() + stripEnd));
            eqType = "Obstacle is not blocking the runway - no recalculations needed:";
            noCalc();
        } else if (displacedThreshold == 0 && ((distanceFromCentreline > 75 || (obstacle.getDistanceFromThreshold() < (-stripEnd)) ||
    ...
    public int getRotateValue() {
        return Integer.parseInt(designator.substring(0, 2)) * 10;
    }
}
