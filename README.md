...
```
cd existing_repo
git remote add origin https://git.soton.ac.uk/yy2g21/comp2211-runway-redeclaration.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.soton.ac.uk/yy2g21/comp2211-runway-redeclaration/-/settings/integrations)
...
helpful if it requires external setup, such as starting a Selenium server for com.example.runway_redeclaration.testing in a browser.
